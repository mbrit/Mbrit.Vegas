...
{
    internal class WinLoseDrawRoundsBucket : RoundsBucket<WinLoseDrawType>, IWinLoseDrawRoundsBucket
    {
        ...
        internal static IWinLoseDrawRoundsBucket GetWinLoseBucket(int numRounds, int handsPerRound, decimal houseEdge, Random rand)
        {
