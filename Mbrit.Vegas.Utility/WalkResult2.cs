...
//        internal WalkResult2(int bankroll, int totalWagered, IEnumerable<Chain> winChains, IEnumerable<Chain> lossChains, IEnumerable<WinLoseDrawType> vectors, WalkOutcome outcome)
//        {
