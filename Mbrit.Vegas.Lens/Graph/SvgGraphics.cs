...
internal class SvgGraphics : IGraphics
{
    ...
    public void DrawString(string label, Font font, Brush brush, float x, float y, StringFormat format = null)
    {
    ...
    public void FillEllipse(Brush brush, float x, float y, int width, int height)
    {
    ...
    {
        return brush is SolidBrush sb ? ColorToHex(sb.Color) : "#000";
    }
}
